            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="font-baloo text-brown-400 flex flex-col text-4xl font-bold">
                  ...
                  <span className="">
                    With PawCoach, raising a well-behaved, happy pet is easier
                    than ever.
                  </span>
                </h1>
                <p className="text-brown-300">
                  Whether you're welcoming a new pup or fine-tuning your furry
                  friend’s behavior, PawCoach gives you expert guidance,
                  interactive lessons, and real-world tips &mdash; all in one
                  friendly app.
                </p>
              </div>
